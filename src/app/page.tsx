...
export default function Home() {
  ...
  return (
    <main
      className="mt-12 min-h-screen bg-gradient-to-b from-white to-gray-50"
      data-aos="fade-up"
    ...
    >
        ...
        <div className="flex flex-col lg:flex-row items-center gap-8 lg:gap-12">
          ...
          <div className="w-full lg:w-1/2 text-center lg:text-left">
            ...
            <p className="text-gray-600 mb-8 text-base lg:text-lg leading-relaxed max-w-lg mx-auto lg:mx-0">
              We help businesses across industries embrace digital
              transformation with intelligent products, scalable platforms, and
      ...
      <section className="container-fluid mx-auto px-4 md:px-6 lg:px-36 py-8">
          ...
          <div className="w-full lg:w-1/2 mt-16">
            ...
            <div className="flex items-start gap-10 mb-10">
              <div className="font-bold text-blue leading-none">
                <span className="text-5xl md:text-8xl ">85+</span>
                <br />
                <br />
                <span>Projects Delivered</span>
              </div>
              <div className="text-gray-700 font-medium">
                With over 5 years in operation and a team of 50+ certified
                professionals, KClub helps businesses transform challenges into
                tailored technology solutions. From AI-powered platforms to
                enterprise-grade applications, we deliver innovations that
      ...
      >
        ...
        <div className="text-center mb-12">
          ...
          <p className="mt-4 text-gray-600 max-w-2xl mx-auto">
            Power your growth with AI, ERP, and digital solutions built around
            your business needs.
          </p>
        </div>
      ...
      <section className="container mx-auto px-4 md:px-6 lg:px-20 py-16">
        ...
        <div className="text-center mb-12">
          ...
          <p className="mt-4 text-gray-600 max-w-2xl mx-auto">
            Innovative solutions designed to transform operations across every
            sector.
          </p>
        </div>
