...
export default function ProductDetail({ params }: { params: { slug: string } }) {
  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-white to-gray-50">
      {/* Hero Section */}
      {/* <section className="container mx-auto px-4 md:px-6 lg:px-36 py-12 mt-20">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative bg-gray-300 h-60 flex items-center justify-center rounded-lg">
            <button className="w-14 h-14 bg-gray-700 text-white rounded-full">
              ▶
            </button>
          </div>
        </div>
