...
//             Have a project in mind or curious about how Kitcub can help your
//             business grow? Our team is here to answer your questions, explore
//             your ideas, and guide you toward the right solutions.
//           </p>
//         </div>
...
//               Our global presence allows us to serve businesses across regions
...
export default function ContactUs() {
  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-white to-gray-50 mx-auto px-4 md:px-6 lg:px-24 py-10 mt-20">
      {/* Header Section */}
      <div className="text-center mb-12">
        <h1 className="text-3xl md:text-4xl font-bold text-black mb-4 leading-tight">
          Connect With Us to Begin Your Digital Journey
        </h1>
        <p className="text-gray-600 text-sm md:text-base max-w-2xl mx-auto">
          Have a project in mind or curious about how Kitcub can help your
          business grow? Our team is here to answer your questions, explore your
          ideas, and guide you toward the right solutions.
        </p>
      </div>

      {/* Hero Image */}
      <div className="w-full h-56 sm:h-72 md:h-96 mb-12">
        <img
          src="contact-img/hero.png"
          alt="Contact Hero"
      ...
      <div className="flex flex-col lg:flex-row gap-10">
        {/* Offices */}
        <section className="bg-[#f2f5ff] rounded-lg p-6 flex-1">
          <h2 className="text-2xl font-bold mb-2 text-black">Our Offices</h2>
        ...
        <div className="flex-1 bg-white p-6 rounded-lg shadow-sm">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              ...
              {errors.choice && (
                <p className="text-red-500 text-xs mt-1">{errors.choice}</p>
              )}
            </div>
            ...
            <button
              type="submit"
              className="w-full bg-[#1a3eec] text-white py-2 rounded-md text-sm md:text-base hover:bg-gray-900 transition"
            >
              Submit
            </button>
          </form>
      ...
      <section className="mt-16 py-10">
        <p className="text-center font-semibold text-black mb-6">
          Trusted by the world&apos;s best companies
        </p>
