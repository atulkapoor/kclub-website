...
const team = [
  {
    ...
    image: "/services-img/ai-services1.png",
    desc: "Aarav specializes in building scalable AI-driven systems and has over 8 years of experience in computer vision and machine learning.",
    socials: {
      linkedin: "#",
      twitter: "#",
      dribbble: "#",
  ...
  },
  {
    ...
    image: "/services-img/ai-services1.png",
    desc: "Priya focuses on creating user-centered design experiences that blend functionality with visual appeal. She has worked with global SaaS brands.",
    socials: {
      linkedin: "#",
      twitter: "#",
      dribbble: "#",
  ...
  },
  {
    ...
    image: "/services-img/ai-services1.png",
    desc: "Rohan is a skilled developer experienced in React, Node.js, and cloud architecture. He ensures performance and scalability in every project.",
    socials: {
      linkedin: "#",
      twitter: "#",
      dribbble: "#",
  ...
  },
  {
    ...
    image: "/services-img/ai-services1.png",
    desc: "Neha manages cross-functional teams and ensures timely project delivery with a focus on client satisfaction and agile development.",
    socials: {
      linkedin: "#",
      twitter: "#",
      dribbble: "#",
  ...
  },
  {
    ...
    image: "/services-img/ai-services1.png",
    desc: "Karan transforms raw data into meaningful insights using Python, TensorFlow, and advanced analytics. Passionate about AI research.",
    socials: {
      linkedin: "#",
      twitter: "#",
      dribbble: "#",
  ...
  },
  {
    ...
    image: "/services-img/ai-services1.png",
    desc: "Simran crafts data-driven marketing strategies that boost brand visibility and engagement across multiple digital platforms.",
    socials: {
      linkedin: "#",
      twitter: "#",
      dribbble: "#",
    ...
    <main className="min-h-screen bg-gradient-to-b from-white to-gray-50">
      <section className="container-fluid mx-auto px-4 md:px-6 lg:px-36 py-12 lg:py-4 mt-30">
        ...
        <div className="text-center max-w-8xl mx-auto mb-12">
          ...
          <p className="text-gray-600 max-w-4xl mx-auto text-sm md:text-base">
            At KClub, we believe every challenge holds an opportunity. Our team
            of innovators, designers, and engineers build solutions that drive
            efficiency today and unlock growth for tomorrow.
          </p>
        </div>
      ...
      <section className="container-fluid mx-auto px-4 md:px-6 lg:px-36 py-12 lg:py-4 mt-30">
        ...
        <div className="grid md:grid-cols-2 gap-12">
          ...
          <div>
            ...
            <p className="text-gray-700 mb-4 max-w-3xl">
              We pride ourselves on crafting software that not only meets
              clients&apos; needs but blows away expectations, often redefining
              how organizations operate in the digital era.
            </p>
            <p className="text-gray-700 max-w-3xl">
              Innovation is in our DNA. We are architects of innovation,
              sculpting solutions that drive efficiency and spark growth. Guided
              by a robust 4D execution methodology – Discuss, Design, Develop,
              Deliver – we ensure each project is handled with a people-first
              approach, streamlined processes, and the latest technology. With
              offices in India, UAE, USA, and Singapore, our global team works
              around the clock to support our clients. We work hard, celebrate
              successes, and constantly push boundaries to turn ambitious ideas
        ...
        <div className="grid md:grid-cols-2 gap-2 items-center mt-20">
          ...
          <div>
            ...
            <p className="text-gray-700 mb-4 max-w-3xl">
              Every project we undertake is guided by our mission and vision. We
              believe in innovation with impact, integrity in execution, and
              lasting value creation for our partners. Curious to see this in
              action? Explore our Case Studies to witness how these values come
              alive in real client success stories.
            </p>

            <h5 className="font-semibold mb-2">Our Mission</h5>
            <p className="text-gray-700 mb-4 max-w-3xl">
              To empower businesses through innovative technology solutions that
              solve real-world challenges and drive digital transformation. We
              exist to deliver high-quality, customized products and services
              that enable our clients to thrive, grow, and outpace the
            ...
            <p className="text-gray-700 max-w-3xl">
              ...
              reshaping industries with game-changing tech innovation. We aspire
              to continuously push the boundaries of what&apos;s possible,
              transforming how organizations work, connect, and succeed –
              ultimately building a smarter, more connected future.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="container-fluid mx-auto px-4 md:px-6 lg:px-36 py-20 mt-10 bg-[#D4E5FD]">
        ...
        <p className="text-center text-gray-600 max-w-2xl mx-auto mb-12">
          Our journey is defined by measurable impact. With every project
          delivered, client served, and milestones achieved, we continue to set
          new standards in digital transformation.
        </p>
      ...
      <section className="container-fluid mx-auto px-4 md:px-6 lg:px-36 py-12 lg:py-4">
        <div className="text-center max-w-3xl mx-auto mb-12">
          ...
          <p className="text-gray-600 mt-4">
            ...
            share a passion for technology and impact. Together, we bring ideas
            to life and deliver solutions that empower businesses worldwide.
          </p>
        </div>
        ...
        <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
          {team.map((member, i) => (
            ...
            >
              ...
              <p className="text-black text-sm mt-3">{member.desc}</p>
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
          ...
          <div>
            ...
            <p className="text-gray-300 mt-2 max-w-lg">
              Explore how we&apos;ve helped businesses across industries
              transform through innovation and technology.
            </p>
          </div>
      ...
      <section className="mx-2 sm:mx-6 py-12 lg:py-14 md:mx-2 lg:mx-14 xl:mx-16 2xl:mx-34">
        <HeroSection
          styles={{
            description: {
              width: "100%",
            ...
            container: {
              backgroundImage: "url('/cta1.png')",
            },
          }}
          showPrimaryButton={false}
          title="Let's Build the Future Together"
          description="Explore how we've helped businnesses across industries transform through innovation and technology"
        />
      </section>
      ...
      <section className="text-white mx-auto px-4 md:px-6 lg:px-36 py-12 lg:py-14 mt-20 rounded-md">
        <div className="overflow-hidden whitespace-nowrap w-full bg-white">
          <div className="flex animate-scroll">
            ...
            {logos.map((logo, i) => (
              <div key={`dup-${i}`} className="flex items-center mx-8 shrink-0">
                <img src={logo.src} alt={logo.alt} className="h-8 mr-2" />
                {/* <span className="text-black font-medium">{logo.alt}</span> */}
              </div>
            ))}
